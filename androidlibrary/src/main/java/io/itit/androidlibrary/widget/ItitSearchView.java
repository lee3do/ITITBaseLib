 ...
 */
public class ItitSearchView extends LinearLayout {
    ...
    private Runnable mShowImeRunnable = () -> {
        ...
        if (imm != null) {
            HIDDEN_METHOD_INVOKER.showSoftInputUnchecked(imm, ItitSearchView.this, 0);
        }
    };

    private Runnable mUpdateDrawableStateRunnable = this::updateFocusedState;

    public ItitSearchView(Context context) {
        this(context, null);
    }

    public ItitSearchView(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.itit_search_view, this, true);
    ...
    public static class SearchAutoComplete extends android.support.v7.widget.AppCompatAutoCompleteTextView {
        ...
        void setSearchView(ItitSearchView searchView) {
